...
Review the following {{language}} changes for performance only.
Focus on hot-path waste, repeated work, query fan-out, blocking operations, avoidable allocations, contention, and scalability regressions.
Ignore correctness, security, and maintainability issues unless they directly create performance risk.
...
If you do not find a material performance issue, say that briefly.
